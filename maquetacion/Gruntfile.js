module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: ['bower_components/jquery/dist/jquery.js', 'bower_components/imagesloaded/imagesloaded.pkgd.js', 'bower_components/isotope/dist/isotope.pkgd.js', 'bower_components/flexslider/jquery.flexslider-min.js', 'js/jquery.validate.min.js', 'js/jquery.tagsinput.min.js', 'js/jquery-ui.js', 'js/validate.js', 'js/plugins.js', 'js/main.js'],
                dest: 'js/app.js'
            }
        },
        sass: {
