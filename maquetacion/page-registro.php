...
<section class="registro main-page">
    <div class="wrap">
        <div class="registro-form">
            <form action="" class="formulario form-registro">
                ...
                <div class="column">
                    ...
                    <div class="input-group">
                        ...
                        <div class="radio--group">
                            <div class="radio__item">
                                <label for="radio1"><input id="radio1" type="radio" name="radio" value="Si" class="guess">Si</label>
                            </div><!--.radio__item-->
                            <div class="radio__item">
                                <label for="radio2"><input id="radio2" type="radio" name="radio" value="No" class="student">No</label>
                            </div><!--.radio__item-->
                    ...
                    <div class="input-group new-ele disable">
